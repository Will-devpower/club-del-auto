    ...
    <div>
      <div className="navegacion">
        ...
        <nav className="nav-menu" style={{ top: top }}>
          <Link to="/" className="nav-link cda-btn2">
            Home
          </Link>
          <Link to="/contacto" className="nav-link cda-btn2">
            Contáctanos
          </Link>
          {uid !== undefined ? (
            <Link to="/client-account" className="log-in cda-btn1">
              Mi cuenta
            </Link>
          ) : (
            <Link to="/login" className="log-in cda-btn1">
