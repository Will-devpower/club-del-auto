...
export const FormChoque = () => {
  ...
  const handleInputChange = ({ target }) => {
    if (
      target.name === "telefonoConductor" ||
      target.name === "telefonoTercero"
    ) {
    ...
    <div className="formulario choque-form">
      ...
      <div className="rendered-form robo-form">
        ...
        <div className="formbuilder-text form-group">
          <label htmlFor="rutConductor" className="rutIndication">
            Ingrese rut sin puntos, con guión y dígito verificador
          </label>
          <input
            type="text"
            placeholder="RUT"
            maxLength="12"
            {...register("rutConductor", {
              required: "Campo Obligatorio",
              pattern: {
                value: /([0-9]{8})-([A-Za-z0-9]{1})/,
                message: "Formato de rut incorrecto. Ej: 12345678-K",
              },
            })}
            className={
              errors.rutConductor
                ? "wrong-field input-control input-field"
        ...
        <div className="formbuilder-text form-group">
          <input
            ...
            {...register("telefonoConductor", {
              required: "Campo Obligatorio",
              pattern: {
                value: /([0-9]{9})/,
                message: "Teléfono incorrecto. Ej: 955555555",
              },
            })}
            className="input-control input-field"
            onChange={handleInputChange}
        ...
        <div className="formbuilder-text form-group">
          <input
            type="email"
            placeholder="Correo"
            {...register("correoConductor", {
              required: "Campo Obligatorio",
              pattern: {
                value:
                  /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/,
                message: "Correo incorrecto. Ej: correo@micorreo.com",
              },
            })}
            className="input-control input-field"
            onChange={handleInputChange}
        ...
        <div>
          <h3 className="heading-11-copy _2">Datos del tercero</h3>
        </div>
        <div className="">
          <h3 className="paragraph-5-copy">Identificación del conductor</h3>
        </div>
        <div className="formbuilder-text form-group">
          <label htmlFor="rutTercero" className="rutIndication">
            Ingrese rut sin puntos, con guión y dígito verificador
          </label>
          <input
            type="text"
            ...
            {...register("rutTercero", {
              ...
              minLength: {
                value: 5,
                message: "Este campo debe incluir 5 caracteres como minimo",
              },
              pattern: {
                value: /([0-9]{8})-([A-Za-z0-9]{1})/,
                message: "Formato de rut incorrecto. Ej: 12345678-K",
        ...
        <div>
          <h3 className="paragraph-5-copy">Identificación del otro vehículo</h3>
        </div>
        <div className="formbuilder-text form-group">
          <input
            type="text"
        ...
        <div className="formbuilder-radio-group form-group field-tieneSeguro">
          ...
          <div className="radio-group">
            <div className="formbuilder-radio-inline">
              <label htmlFor="tieneSeguro-0" className="paragraph-4-copy">
                Si
              </label>
              <input
                name="tieneSeguro"
            ...
            <div className="formbuilder-radio-inline">
              <label htmlFor="tieneSeguro-1" className="paragraph-4-copy">
                No
              </label>
              <input
                name="tieneSeguro"
        ...
        <div className="formbuilder-radio-group form-group field-tieneSeguro">
          ...
          <div className="radio-group" style={{ display: "block" }}>
            <div
              className="formbuilder-radio-inline"
              style={{ marginTop: "10px" }}
            >
              <label htmlFor="responsable-0" className="paragraph-4-copy">
                Yo Mismo
              </label>
              <input
                name="responsable"
            ...
            <div
              ...
              style={{ marginTop: "10px" }}
            >
              <label htmlFor="responsable-1" className="paragraph-4-copy">
                El otro vehículo
              </label>
              <input
                name="responsable"
            ...
            <div
              ...
              style={{ marginTop: "10px" }}
            >
              <label htmlFor="responsable-2" className="paragraph-4-copy">
                Otro vehículo no identificado
              </label>
              <input
                name="responsable"
                access="false"
        ...
        <div className="formbuilder-file form-group field-licencia">
          <label htmlFor="licencia" className="formbuilder-file-label">
            Licencia de conducir<span className="formbuilder-required">*</span>
          </label>
          <input
            type="file"
            name="licencia"
        ...
        <div className="formbuilder-file form-group">
          <label htmlFor="licenciaT" className="formbuilder-file-label">
            Licencia de tercero<span className="formbuilder-required">*</span>
          </label>
          <input
            type="file"
            name="licenciaT"
        ...
        <div className="formbuilder-file form-group">
          <label htmlFor="fotosTUploader" className="formbuilder-file-label">
            Fotos de daños tercero
            <span className="formbuilder-required">*</span>
          </label>
          <input
            type="file"
