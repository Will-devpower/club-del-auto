...
export const CuponScreen = () => {
  ...
  const coupon = useSelector((state) =>
    state.cda.cupons.find((coupon) => coupon.id === parseInt(id))
  );
      ...
      {showTerms && (
        <div className="terminos-container">
          <div className="terminos-popup">
            <p>{coupon.terminos}</p>
            <button className="cda-btn1 terminos-btn" onClick={ShowTerms}>
              OK
            </button>
          </div>
        </div>
        ...
        <div className="div-block-26">
          <div>
            <div
              ...
              style={{ backgroundImage: `url(${baseUrl + coupon.img[0].url})` }}
            ></div>
          ...
          <div className="div-block-27">
            ...
            <div className="div-block-28">
              <img
                src="https://uploads-ssl.webflow.com/60da07a904f25339b115d11e/60f4c1eb32558eee7089b5bf_Porcentajes_2.png"
                alt="icono1"
                className="image-22"
              />
                ...
                <label>
                  ...
                  >
                    {vehiculos.map((veh, key) => (
                      <option value="veh.patente" id="veh.patente" key={key}>
                        {veh.patente}
                      </option>
                    ))}
                  </select>
                </label>
                <span className="boton-comprar-servicio" onClick={getCoupon}>
                  Obtener cupón
                </span>
              </div>
            )}
            ...
            <div className="div-block-28">
              <img
                src="https://uploads-ssl.webflow.com/60da07a904f25339b115d11e/60f4c1ebb62a5610e369699e_TerminosCondiciones_1.png"
                alt=""
                className="image-22"
              />
              <p className="terminos-condiciones" onClick={ShowTerms}>
        ...
        <div className="div-block-26-copy">
          ...
          {coupon.direcciones.map((direccion, key) => (
            <div className="div-block-29" key={key}>
              <img
                src="https://uploads-ssl.webflow.com/60da07a904f25339b115d11e/60f4c569fb792d607478e0a9_Location.png"
                alt="icono-gps"
                className="image-23"
              />
              <p
                className="texto-ubicacion"
                onClick={() => loadMap(direccion.direccion)}
              >
                {direccion.direccion}
              </p>
            </div>
