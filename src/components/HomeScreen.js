      ...
      <div className="">
        <div className="banner">
          ...
          <h1 className="heading">
            Nos preocupamos <br /> por tu seguridad
          </h1>
        </div>
        <div className="section-2">
          ...
          <div className="asistencias">
            <img
              src={carImg}
              loading="lazy"
              sizes="(max-width: 767px) 100vw, (max-width: 991px) 470px, 600px"
              alt="car-img"
              className="image-12"
              data-aos="fade-left"
            />
            <div className="div-block-9">
              ...
              {uid !== undefined ? (
                <a href="/form-select" className="w-button">
                  Registra Choque/Robo
                </a>
              ) : (
                <Link
                  to="/login"
                  className="w-button"
                  value="Registra Choque/Robo"
                >
                  Inicia sesión para continuar
                </Link>
              )}
