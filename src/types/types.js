...
export const types = {     
    ...
    GET_COUPON_CLIENTE: 'GET_COUPON_CLIENTE',
    GET_COUPON_CLIENTE_SUCCESS: 'GET_COUPON_CLIENTE_SUCCESS',
    GET_TEXTOS_APP: 'GET_TEXTOS_APP',
    GET_TEXTOS_SUCCESS: 'GET_TEXTOS_SUCCESS',
    GET_BANNERS_CUPONES: 'GET_BANNERS_CUPONES',
